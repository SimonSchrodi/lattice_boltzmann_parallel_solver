...
\begin{figure}
  \begin{center}
    \subfigure[Strouhal number as function of the Reynolds number]{	\scalebox{0.4}{\input{../figures/von_karman_vortex_shedding/reynold_strouhal/reynold_strouhal.pgf}}}
        \subfigure[Strouhal number as function of the width of the simulation domain]{	\scalebox{0.4}{\input{../figures/von_karman_vortex_shedding/nx_strouhal/nx_strouhal.pgf}}}
            \subfigure[Strouhal number as function of the blockage ratio]{	\scalebox{0.4}{\input{../figures/von_karman_vortex_shedding/blockage_strouhal/blockage_strouhal.pgf}}}
...
\begin{figure}
  \begin{center}
	\scalebox{0.7}{\input{../figures/von_karman_vortex_shedding/scaling_test/scaling_test_420_180.pgf}}
